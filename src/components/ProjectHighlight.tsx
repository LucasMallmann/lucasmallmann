    ...
    <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
      <div className="relative z-10 col-start-1 pt-48 row-start-1 px-4 pb-3 bg-gradient-to-t from-gray-750 sm:bg-none md:pt-0">
        ...
        <Link href="/projetos/primeiro-projeto">
          <h1 className="text-xl font-semibold text-white cursor-pointer sm:text-2xl sm:leading-7 sm:text-black md:text-3xl dark:text-gray-100 hover:opacity-80 transition-opacity duration-200">
      ...
      <div className="col-start-1 row-start-1 flex sm:col-start-2 sm:row-span-3">
        <div className="w-full grid grid-cols-3 grid-rows-2 gap-2">
          <figure className="relative col-span-3 row-span-2 md:col-span-2 cursor-pointer">
            <Link href="/projetos/primeiro-projeto">
              <Image
                src={firstImage}
                alt=""
          ...
          <figure className="relative hidden md:block cursor-pointer">
            <Link href="/">
              <Image
                src={secondImage}
                alt=""
          ...
          <figure className="relative hidden cursor-pointer md:block">
            <Link href="/">
              <Image
                src={thirdImage}
                alt=""
