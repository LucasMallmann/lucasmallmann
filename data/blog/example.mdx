...
Quicklink provides two main features: `prefetching` and `preloading`.
...
your website performance, and most important, improve the user experience.

## How does this work?

Well, does it mean the browser will load my page
...
<Link href="/">
  <Image
    ...
    src={`/static/images/example/report.png`}
    width={1000}
    height={500}
  />
</Link>
